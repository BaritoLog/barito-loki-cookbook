...
action :create do
  ...
  raise 'When provided user property can\'t be empty' if new_resource.user&.empty?
  raise 'When provided sddl property can\'t be empty' if new_resource.sddl&.empty?
